...
extern void EncodeOpt_Reg16_Mem16(	uint OptOpcode,
									...
									uint OffType, 
									uint Off);
extern void EncodeOpt_Acc8_Imm8(uchar OptOpcode, uchar Imm8);
extern void EncodeOpt_Acc16_Imm16(uchar OptOpcode, uint Imm16);
extern void EncodeOpt_Reg_Imm8(uint OptOpcode, uint RegW, uchar Reg, uchar Imm8);
extern void EncodeOpt_Mem_Imm8(	uint OptOpcode,
								...
								uint Off,
								uchar Imm8);
extern void EncodeOpt_Reg8_Imm8(uint OptOpcode, uchar Reg8, uchar Imm8);
